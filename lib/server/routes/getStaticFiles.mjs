...
export default async (ctx) => {
  ...
  ctx.assert(pkgDir, 500, 'getStaticFiles: missing pkgDir from config.mjs');
  ...
  ctx.assert(exists, 404, VERBOSE_ERRORS ? `File ${file} does not exists` : 'File does not exists');
